...
> `skills/claude-skills/mapping-driven-loader-pipeline/` in this
> repository; every path below is repo-root-relative because Devin's
> loader reads this file alone. Setup and usage:
> `skills/claude-skills/mapping-driven-loader-pipeline/DEVIN-USAGE.md`.
...
1. **Read the mapping document.** Deterministically, with
   `skills/claude-skills/mapping-driven-loader-pipeline/scripts/mapping_reader.py`, into a `mapping_digest.json`. Never eyeball a
   spreadsheet and start writing code from memory of it.
2. **Scan the existing generator platform in this repository.** See step 2
   below and `skills/claude-skills/mapping-driven-loader-pipeline/references/reuse-existing-generators.md`. You are extending an
   established codebase, not starting one.
3. **Ask the clarifying questions.** The gate list is
   `skills/claude-skills/mapping-driven-loader-pipeline/references/clarifying-questions.md`. Several of them — source SQL, base
...
4. **Write the transformation-mapper Markdown** and have it reviewed. This is
   ...
   `skills/claude-skills/mapping-driven-loader-pipeline/references/transformation-mapper-format.md`.
5. **Generate the pipeline code**, one directory per output file. Layout and
   code templates: `skills/claude-skills/mapping-driven-loader-pipeline/references/generated-pipeline-layout.md`.
...
`skills/claude-skills/mapping-driven-loader-pipeline/references/mapping-document-schema.md`.
...
discovered traps. Details and rationale: `skills/claude-skills/mapping-driven-loader-pipeline/references/reuse-existing-generators.md`.

## Step 3: ask, do not assume

Work through `skills/claude-skills/mapping-driven-loader-pipeline/references/clarifying-questions.md`. Ask in one batch where you
...
Code templates for each emitted file: `skills/claude-skills/mapping-driven-loader-pipeline/references/generated-pipeline-layout.md`.
...
### `skills/claude-skills/mapping-driven-loader-pipeline/scripts/`
...
| `build_sample_mapping.py` | Regenerates `skills/claude-skills/mapping-driven-loader-pipeline/examples/sample-mapping-member-loader.xlsx` — **entirely fictional** member-loader mapping, safe to commit, used to exercise the skill without customer data. |

### `skills/claude-skills/mapping-driven-loader-pipeline/references/`
...
### `skills/claude-skills/mapping-driven-loader-pipeline/examples/`
